...
namespace Mediapipe.Unity.Sample.PoseLandmarkDetection
{
    ...
    public class MP_PantsRigDriver_ad_depthfix_spin : MonoBehaviour
    {
        [Header("Required")]
        ...
        // PantsVisual을 넣으면 roll이 메시에만 적용되고 pivot yaw와 분리되어 안정적이다
        ...
        // - 본을 건드리지 않고 PantsVisual에만 z축 roll을 살짝 준다
